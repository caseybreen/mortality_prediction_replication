...
### Import
dmf_linked <- fread("~/workspace/data/v3/censoc_dmf_v3_linked.csv") %>%
  janitor::clean_names()
...
censoc_dmf_train_data <- training(split)
censoc_dmf_test_data <- testing(split)
```
