---
title: "Prediction by birth cohort" 
author: Casey Breen
---
...
— Here, we test if the predictability varies by birth cohort
...
cohort_fig <- tibble(year = 1900:1920, r2 = results) %>% 
...
ggsave(plot = cohort_fig, filename = here("figures", "appendix_predictability_by_cohort.png"), bg = "white", width = 6, height = 4)
```
