...
Summary: Compare the sample composition of our linked sample to the general population in the 1940 Census.
...
## combine dmf file 
dmf <- read_csv(here("data", "censoc_dmf_v3_linked.csv"))  %>% 
  janitor::clean_names() %>% 
  select(histid) %>% 
  mutate(in_sample = 1)
...
ggsave(rep_plot, filename = here("figures/02_representativeness_plot.png"), height = 6, width = 6)
ggsave(rep_plot, filename = here("figures/02_representativeness_plot.svg"), height = 6, width = 6)
```
